...
@CucumberOptions(
	...
	plugin = {"pretty","junit:target/Jenkins/CVXJunitReport.xml","com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/CVX_ExtentReport2.html"},
	monochrome = true
	)

public class GoIbiboTestRunnerAndroidTabChrome extends AbstractTestNGCucumberTests {
	
	@BeforeClass
	public void selectBrowser() throws InterruptedException
	{
	//	System.out.println("First Before");
		TestBase.browserName="AndroidTabChrome";
