...
@CucumberOptions(
	...
	plugin = {"pretty","junit:target/Jenkins/CVXJunitReport.xml","com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/CVX_ExtentReport6.html"},
	monochrome = true
	)

public class GoIbiboTestRunnerSafari extends AbstractTestNGCucumberTests {
	
	@BeforeClass
	public void selectBrowser() throws InterruptedException
	{
	//	System.out.println("First Before");
		TestBase.browserName="Safari";
