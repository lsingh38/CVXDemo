...
@CucumberOptions(
	...
	plugin = {"pretty","junit:target/Jenkins/CVXJunitReport.xml","com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/CVX_ExtentReport3.html"},
	monochrome = true
	)

public class GoIbiboTestRunnerChrome extends AbstractTestNGCucumberTests {
